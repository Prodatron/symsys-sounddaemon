...
App_BnkNum  db 0                    ;*reserved*                         POST bank number
            db "Sound Tester":ds 12:db 0  ;name
...
;*** SOUNDDAEMON LIBRARY USAGE
use_SySound_RMTACT      equ 1   ;activates remote playing
use_SySound_RMTDCT      equ 1   ;deactivates remote playing
...
use_SySound_MUSCON      equ 1   ;continues playing a music
